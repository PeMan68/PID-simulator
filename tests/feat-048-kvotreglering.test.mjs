...
{
  const appJs = readFileSync(path.join(APP_DIR, "app.js"), "utf8");
  // FEAT-050 (uppföljning, tredje rundan) — PO valde att BEHÅLLA u-panelen
  // och crosshairen oförändrad för alla scenarier (kaskad eller ej), för
  // konsekvent utseende — bekräftat tillbaka till den ursprungliga,
  // ovillkorade raden.
